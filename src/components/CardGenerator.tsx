    ...
    <animated.div style={animation} className="w-full max-w-4xl mx-auto p-8">
      ...
      >
        <div className="bg-white/90 p-8 rounded-lg backdrop-blur-sm">
          ...
          <p className="text-xl text-gray-800 mb-4">Wishing you joy and happiness this holiday season</p>
          {name && <p className="text-2xl font-script text-green-700">From: {name}</p>}
        </div>
      </div>
